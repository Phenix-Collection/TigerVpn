...
public class RatingDialog extends AppCompatDialog implements RatingBar.OnRatingBarChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.codemybrainsout.ratingdialog.R.layout.dialog_rating);

        tvTitle = (TextView) findViewById(com.codemybrainsout.ratingdialog.R.id.dialog_rating_title);
        tvNegative = (TextView) findViewById(com.codemybrainsout.ratingdialog.R.id.dialog_rating_button_negative);
        tvPositive = (TextView) findViewById(com.codemybrainsout.ratingdialog.R.id.dialog_rating_button_positive);
        tvFeedback = (TextView) findViewById(com.codemybrainsout.ratingdialog.R.id.dialog_rating_feedback_title);
        tvSubmit = (TextView) findViewById(com.codemybrainsout.ratingdialog.R.id.dialog_rating_button_feedback_submit);
        tvCancel = (TextView) findViewById(com.codemybrainsout.ratingdialog.R.id.dialog_rating_button_feedback_cancel);
        ratingBar = (RatingBar) findViewById(com.codemybrainsout.ratingdialog.R.id.dialog_rating_rating_bar);
        ivIcon = (ImageView) findViewById(com.codemybrainsout.ratingdialog.R.id.dialog_rating_icon);
        etFeedback = (EditText) findViewById(com.codemybrainsout.ratingdialog.R.id.dialog_rating_feedback);
        ratingButtons = (LinearLayout) findViewById(com.codemybrainsout.ratingdialog.R.id.dialog_rating_buttons);
        feedbackButtons = (LinearLayout) findViewById(com.codemybrainsout.ratingdialog.R.id.dialog_rating_feedback_buttons);
    ...
    private void init() {
        ...
        context.getTheme().resolveAttribute(com.codemybrainsout.ratingdialog.R.attr.colorAccent, typedValue, true);
        int color = typedValue.data;

        tvTitle.setTextColor(builder.titleTextColor != 0 ? ContextCompat.getColor(context, builder.titleTextColor) : ContextCompat.getColor(context, com.codemybrainsout.ratingdialog.R.color.black));
        tvPositive.setTextColor(builder.positiveTextColor != 0 ? ContextCompat.getColor(context, builder.positiveTextColor) : color);
        tvNegative.setTextColor(builder.negativeTextColor != 0 ? ContextCompat.getColor(context, builder.negativeTextColor) : ContextCompat.getColor(context, com.codemybrainsout.ratingdialog.R.color.grey_500));

        tvFeedback.setTextColor(builder.titleTextColor != 0 ? ContextCompat.getColor(context, builder.titleTextColor) : ContextCompat.getColor(context, com.codemybrainsout.ratingdialog.R.color.black));
        tvSubmit.setTextColor(builder.positiveTextColor != 0 ? ContextCompat.getColor(context, builder.positiveTextColor) : color);
        tvCancel.setTextColor(builder.negativeTextColor != 0 ? ContextCompat.getColor(context, builder.negativeTextColor) : ContextCompat.getColor(context, com.codemybrainsout.ratingdialog.R.color.grey_500));
        ...
        if (builder.ratingBarColor != 0) {
            if (Build.VERSION.SDK_INT > Build.VERSION_CODES.KITKAT) {
                ...
                int ratingBarBackgroundColor = builder.ratingBarBackgroundColor != 0 ? builder.ratingBarBackgroundColor : com.codemybrainsout.ratingdialog.R.color.grey_200;
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == com.codemybrainsout.ratingdialog.R.id.dialog_rating_button_negative) {

            dismiss();
            showNever();

        } else if (view.getId() == com.codemybrainsout.ratingdialog.R.id.dialog_rating_button_positive) {

            dismiss();

        } else if (view.getId() == com.codemybrainsout.ratingdialog.R.id.dialog_rating_button_feedback_submit) {

            String feedback = etFeedback.getText().toString().trim();
            if (TextUtils.isEmpty(feedback)) {

                Animation shake = AnimationUtils.loadAnimation(context, com.codemybrainsout.ratingdialog.R.anim.shake);
        ...
        } else if (view.getId() == com.codemybrainsout.ratingdialog.R.id.dialog_rating_button_feedback_cancel) {
    ...
    public static class Builder {
        ...
        private void initText() {
            title = context.getString(com.codemybrainsout.ratingdialog.R.string.rating_dialog_experience);
            positiveText = context.getString(com.codemybrainsout.ratingdialog.R.string.rating_dialog_maybe_later);
            negativeText = context.getString(com.codemybrainsout.ratingdialog.R.string.rating_dialog_never);
            formTitle = context.getString(com.codemybrainsout.ratingdialog.R.string.rating_dialog_feedback_title);
            submitText = context.getString(com.codemybrainsout.ratingdialog.R.string.rating_dialog_submit);
            cancelText = context.getString(com.codemybrainsout.ratingdialog.R.string.rating_dialog_cancel);
            feedbackFormHint = context.getString(com.codemybrainsout.ratingdialog.R.string.rating_dialog_suggestions);
        }
