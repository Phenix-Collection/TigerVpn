...
import com.tigervpn.free.unblock.fast.vpn.activity.BuildConfig;


import com.tigervpn.free.unblock.fast.vpn.activity.R;
import com.tigervpn.free.unblock.fast.vpn.activity.TigerInfoActivity;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener {
    ...
    PendingIntent getLogPendingIntent() {
        ...
        Intent intent = new Intent(getBaseContext(), TigerInfoActivity.class);
